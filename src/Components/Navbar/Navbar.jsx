        ...
        <div className='w-full flex items-center justify-between '>
            <div className='flex items-center justify-center gap-2'>
              ...
              <div className='hidden items-center justify-center gap-16 mr-16 sm:flex md:flex xl:flex'>
                  <Link href="/" className={`${pathname === "/" && "border-b-2 border-green-400" }`}>Home</Link>
                  <Link href="/allCars" className={`${pathname.startsWith('/allCars') && "border-b-2 border-green-400" }`}>Cars</Link>
