...
export default function Footer() {
  return (
    <footer className="flex flex-col items-center bg-white text-center text-white border-t-2 mt-16">
      <div className="flex items-center justify-between sm:flex-row flex-col mb-4">
        <div className="h-full w-1/2 flex items-center justify-center">
          <img src="/logo.png" alt="not found" className="h-full sm:h-64" />
        </div>
        <div className="text-black w-3/4 text-left">
          <div className="text-green-400 font-semibold sm:text-2xl text-center sm:text-left">
            Drive with Confidence, Rent with Trust – Your Journey, Our Priority!
          </div>
          <p className="text-center sm:text-left">
            With transparent pricing, easy booking, and a commitment to
            excellence, we redefine your car rental experience. Your trust is
            the engine that powers us forward, and we guarantee a seamless
